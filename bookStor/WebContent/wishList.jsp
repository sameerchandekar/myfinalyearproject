<%@ page language="java" import="database.*" import="java.sql.*" contentType="text/html; charset=ISO-8859-1"
...
String sql="select mobile_no from usertable where email_id='"+emailid+"'";
...
<br><h1 >Enter Details of Book Bellow:</h1>
<hr width="500"></td></tr>
<form action="wishListServlet" method="post" name="reg">
...
<td align="left">
<div id="searchFormDesign"><input type="text" name="bookname"></div></td>
</tr>
<tr>
<td align="right">* Name of the Author:</td>
<td align="left"><input type="text" name="author"></td>
</tr>
<input type="hiddden" name="mobileno" value="<%=mobile %>">
<a onclick="<% %>>"></a>
...
<tr>
<td align="right"><input type="submit" value="submit" name="b1" onclick='return validate(this.form)'></td>
