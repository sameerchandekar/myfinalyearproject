    ...
    <div id="containerPage">
        <div id="mainContainer">
         ...
         <div id="divLeft" style="margin-left: -16px;" class="hmLeftBand">
            <jsp:include page="showLeftBand.jsp"></jsp:include>
        </div>
        <!--hmLeftBand -->
        ...
        <img width="760" height="60" border="0" style="display: block; border-top-left-radius: 0.5em;
            ...
            <div class="main-deals-cont">
                <div class="home-deals-outer">
                    ...
                    out.print(cat);
                      retrive.selectQuery(cat);
                      while(retrive.rs.next())
                      { 
                      bookBean b=new bookBean();
                      b=retrive.setRS();
                      out.print("<div style=\"float:left\">");
                      out.print("<a href=\"http://www.indiaplaza.com/gp-combo-smita-kaushik-aniesha-brahma-shobhit-agarwal/books/9789380914299.htm\" title=\""+b.getBookname()+"\">");
